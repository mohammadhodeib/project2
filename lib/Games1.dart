...
class MyWrapperClass extends StatefulWidget {
  final List<Map<String, dynamic>> mylist;

  MyWrapperClass({required this.mylist});

  @override
  _MyWrapperClassState createState() => _MyWrapperClassState();
}

class _MyWrapperClassState extends State<MyWrapperClass> {
      ...
      bottomNavigationBar: BottomAppBar(
        child: Row(
          ...
          children: [
            TextButton(
              onPressed: () async {
                mydataList = await fetchData(preferences1[0]).timeout(Duration(seconds: 30));
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => MyWrapperClass1(mylist: mydataList,)),
                );
              },
              child: Text(
                'Show All My Games',
